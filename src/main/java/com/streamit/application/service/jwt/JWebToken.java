...
public class JWebToken {
    ...
    //TbDd2e5HoQ0q0YhJ4hS2rLVWchNS5ilKb4Xmi5PIghWJjOc1OeB
    private static final String SECRET_KEY = "TbDd2e5HoQ0q0YhJ4hS2rLVWchNS5ilKb4Xmi5PIghWJjOc1OeB"; //@TODO Add Signature here
    ...
    public JWebToken(String payloadStr,Object obj) {
        this();
        encodedPayload = encode(payloadStr.getBytes(StandardCharsets.UTF_8));
        signature = hmacSha256(encodedHeader + "." + encodedPayload, SECRET_KEY);
    ...
    public boolean isValid2() {
        return signature.equals(hmacSha256(encodedHeader + "." + encodedPayload, SECRET_KEY)); //signature matched
    }
